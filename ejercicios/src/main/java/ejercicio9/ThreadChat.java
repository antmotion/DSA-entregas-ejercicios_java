...
public class ThreadChat implements Runnable {
    private static List<ThreadChat> threadList = Collections.synchronizedList(new ArrayList<ThreadChat>());
    ...
    public ThreadChat(Socket socket) throws IOException {
        this.socket = socket;
